...
const IssueToMember = () => {
  return (
    <div className="container">
      ...
      <div className="row" style={{ marginTop: "20px" }}>
        {/* Student Info */}
        <div className="col-md-6" style={{ borderRight: "1px solid #000", display: "flex", justifyContent: "center", alignItems: "center" }}>
          <div style={{ textAlign: "center", padding: "20px" }}>
            ...
            <div>
              ...
              <p>
                ...
                Email: prachi.parihar@cumminscollege.in
                <br />
                Address: Cummins College of Engineering Karvenagar, Pune 123456
              </p>
            </div>
          </div>
        </div>
